...
package com.keygenqt.demo_contacts.modules.favorite.navigation.graph.impl
...
fun NavGraphBuilder.favoriteScreenGraph(
    ...
    composable(FavoriteNav.MainNav.FavoriteScreen.route) {
        FavoriteScreen(viewModel = hiltViewModel()) { event ->
            when (event) {
                is FavoriteEvents.NavigateToSignIn -> navActions.navigateToSignIn()
